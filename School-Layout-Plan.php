...
--darkBackgroundDark: #222;
            ...
            <div class="contents-wrapper">
                ...
                <section class="post-full-content">
                    ...
                    <h1 class="post-full-title" style="text-align: center;">COLLEGE LAYOUT</h1>
                    </div>
                    <div class="post-content">
            <center> <h3><strong>School Layout Plan</strong></h3> </center>
            <br/><br/>
            <img class="responsive-img" src="img/School-Layout-Plan.jpg">
        </div>
        </div>
        </div>
    </div>
