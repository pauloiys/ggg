...
<?php
    ...
    <div style="text-align: center;">
        <a href="#" target="_blank"-->
            <img class="responsive-img" src="College Assests/Section Banner Landscape.jpg">
        </a>
</div>
    <section>
        <style>
...
--darkBackgroundDark: #222;
            ...
            <div class="contents-wrapper">
                ...
                <section class="post-full-content">
                    ...
                    <h1 class="post-full-title" style="text-align: center;">COLLEGE FACILITIES</h1>
                    </div>
                    <div class="post-content">
            <!--center>  <h1><strong>Physical-Facilities</strong></h1> </center-->
            <img class="responsive-img" height="auto" width="auto" src="img/college_facilities.jpeg">
        </div>
    </div>
    </div>
