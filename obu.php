  ...
  .mobileVideo {
    ...
    margin-top: 88px;
        ...
        <!--section class="sec5">
            ...
            <video autoplay='true' muted playsinline autobuffer loop controls class="mobileVideo" width="100%" height="600">
...
<!--div class="container">
    <div class="row">
        ...
        <!--div class="col-md-8">
            <div class="vid">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/56v6qabWJAA" allowfullscreen=""></iframe>
