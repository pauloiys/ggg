...
--darkBackgroundDark: #222;
            ...
            <div class="contents-wrapper">
                ...
                <section class="post-full-content">
                    ...
                    <h1 class="post-full-title" style="text-align: center;">COLLEGE ACADEMICS</h1>
                    </div>
                    <div class="post-content">
            <!--center>  <h1><strong>Academic-Progress</strong></h1> </center-->
            <img class="responsive-img" height="1001px" width="auto" src="img/Academic-progress.jpeg">
        </div>
    </div>
    </div>
