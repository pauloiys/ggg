...
<?php
    ...
    <div style="text-align: center;">
        <a href="#" target="_blank">
            <img class="responsive-img" src="Administration/admin-staff.jpg">
        </a>
</div>
    <section>
        <style>
...
--darkBackgroundDark: #222;
            ...
            <div class="contents-wrapper">
                ...
                <section class="post-full-content">
                    ...
                    <h1 class="post-full-title" style="text-align: center;">ORGANIZATIONAL STRUCTURE</h1>
                    </div>
                    <div class="post-content">
          <!--center>  <h1><strong>Organizational Structure</strong></h1> </center-->
            <img class="responsive-img" height="auto" width="auto" src="img/Organizational-Structure.jpg">
        </div>
    </div>
</div>
