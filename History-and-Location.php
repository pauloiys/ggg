    ...
    <!-- /header -->
        ...
        <div style="text-align: center;">
            <a href="#" target="_blank">
                <img class="responsive-img" src="College Assests/College-Items/home-section2.jpg">
            </a>
    </div>
        <section>
            <style>
...
.post-full-meta {
    margin: -5vw -9vw 2vw;
                ...
                <h1>History and Location</h1>
                </br>
            </br>
          <center>  <img class="responsive-img" src="img/crest-bw.png" style="width: 250px; height:250px;"> </center>
        </br>
                
        <section>
            <!--audio id="audio" preload="none" style="width: 100%;" autoplay controls allow="autoplay">
                <source type="audio/mp3" src="Audios/Historyofcollege.mp3"/>
            </audio-->	
                    ...
                    <p>Starting from cadjan sheds and horse stable structures, the school now has a set
                        ...
                        <center>  <img class="responsive-img" src="img/College-in-1906.jpg" style="width: 1000px; height:auto;"> </center>
                    ...
                    <center>  <img class="responsive-img" src="img/Crests.jpg" style="width: auto; height:auto;"> </center>
